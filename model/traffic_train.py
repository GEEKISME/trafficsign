...
from process import  data_input
...
def train(datagen, model,train_x,train_y,test_x,test_y):
    ...
    plt.ylabel("loss/acc")
    plt.legend(loc="best")
    plt.savefig("../result/result_me_1.png")
    plt.show()
...
if __name__ =="__main__":
    ...
    train(datagen,model,train_x,train_y,test_x,test_y)#训练
